...
<!--    <link href="//unpkg.com/nprogress@0.2.0/nprogress.css" rel="stylesheet" />  进度条 
    ...
    <link rel="stylesheet" href="/dist_js_css/element-plus@2.2.21.index.css" /> 
    <script src="/dist_js_css/vue@3.2.45.vue.global.prod.js"></script>
    <script src="/dist_js_css/vue-router@4.1.6.vue-router.global.prod.js"></script>
    <script src="/dist_js_css/vuex@4.0.2.vuex.global.prod.js"></script>
    <script src="/dist_js_css/element-plus@2.2.21.index.full.min.js"></script>
    <script src="/dist_js_css/nprogress@0.2.0.nprogress.js"></script>
    <script src="/dist_js_css/dayjs@1.11.5.dayjs.min.js"></script>
    
    <script src="/dist_js_css/xlsx@0.18.5.xlsx.core.min.js"></script> <!-- excel -->
    <script src="/dist_js_css/qrcode.vue@3.3.3.qrcode.vue.browser.min.js"></script> <!-- qrcode -->
    <script src="/dist_js_css/clipboard@2.0.8.clipboard.min.js"></script> <!-- clipboard -->
    <script src="/dist_js_css/antv.g2plot@2.4.20.g2plot.min.js"></script> <!-- g2plot -->
    <script src="/dist_js_css/amap.amap-jsapi-loader@1.0.1.index.js"></script> <!-- amap -->
    
    <link href="/dist_js_css/font-awesome@4.7.0.css.font-awesome.css" rel="stylesheet" />
    <link href="/dist_js_css/nprogress@0.2.0.nprogress.css" rel="stylesheet" /> <!-- 进度条 -->

    <!-- edit -->
    <link href="/dist_js_css/wangeditor.editor@5.1.23.css.style.css" rel="stylesheet">
    <script src="/dist_js_css/wangeditor.editor@5.1.23.index.js"></script>
    <!-- edit -->  
